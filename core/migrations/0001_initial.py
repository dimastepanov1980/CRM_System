# Generated by Django 5.0.6 on 2024-08-16 07:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=100)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.company')),
                ('schedule_entries', models.ManyToManyField(to='core.scheduleentry')),
                ('specialists', models.ManyToManyField(blank=True, related_name='schedules', to='core.specialist')),
            ],
        ),
        migrations.AddField(
            model_name='specialist',
            name='work_schedule',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.workschedule'),
        ),
    ]

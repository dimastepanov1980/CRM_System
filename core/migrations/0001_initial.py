# Generated by Django 5.0.6 on 2024-08-08 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.company')),
                ('services', models.ManyToManyField(blank=True, related_name='related_specialists', to='core.service')),
            ],
        ),
        migrations.AddField(
            model_name='service',
            name='specialists',
            field=models.ManyToManyField(blank=True, related_name='related_services', to='core.specialist'),
        ),
        migrations.CreateModel(
            name='Event',
            fields=[
